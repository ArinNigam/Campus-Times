...
class RoomVacancy extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (ref.read(roomProvider).loadingState == LoadingState.progress)
                    ...
                    children: [
                      for (Room room in ref.read(roomProvider).roomList)
                        MenuTile(
                              ...
                              builder: (_) => Dialog(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                          "${room.name} : ${room.vacant ? 'Vacant' : 'Occupied'}",
                          ...
                          icon: Icons.class_,
                          primaryColor: room.vacant
                              ? Colors.green.shade800
                              : Colors.red.shade800,
                          secondaryColor: room.vacant
