...
import 'package:campus_times/models/faculty.dart';
...
class FacultyProfile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final Faculty currentFaculty =
        ref.read(authProvider).currentUser as Faculty;
    return Card(
        child: Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          Text('Email: ${currentFaculty.email}',
              style: TextStyle(fontSize: 16)),
          Text('Department: ${currentFaculty.department}',
              style: TextStyle(fontSize: 16)),
          Text('Cabin Number: ${currentFaculty.cabinNumber}',
              style: TextStyle(fontSize: 16)),
