...
import 'package:campus_times/components/borderless_button.dart';
import 'package:campus_times/components/material_textformfield.dart';
import 'package:campus_times/provider/lost_and_found_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ResponsiveScaledBox(
      ...
      child: Scaffold(
                              ...
                              if (ref
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: () => ref
                                          .watch(lostAndFoundProvider.notifier)
                              ...
                              builder: (_, ref, __) {
                                return AnimatedToggleSwitch.dual(
                                  ...
                                  styleBuilder: (value) => value ==
                                          LostAndFoundConstants.lostState
                                      ? ToggleStyle(
        ...
        body: ref.watch(lostAndFoundProvider).loadingState ==
                    ...
                    children: <Widget>[
                      for (var item in ref
                        ...
                        ImageTile(
                          ...
                          primaryColor: item.isLost
                              ? Colors.red.shade800
                              : Colors.green.shade800,
                          secondaryColor: item.isLost
                              ? Colors.red.shade400
                                        ...
                                        builder: (_, ref, __) {
                                          ...
                                          if (ref
                                            ...
                                            userId = (authState.currentUser
                                              ...
                                              'admin') {
                                            userId =
                                                (authState.currentUser as Admin)
                                                    .id;
                                          } else {
