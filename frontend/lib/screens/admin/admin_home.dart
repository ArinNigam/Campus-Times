...
import 'package:campus_times/components/collapsing_app_bar.dart';
import 'package:campus_times/provider/admin_provider.dart';
import 'package:campus_times/provider/auth_provider.dart';
import 'package:campus_times/services/auth/auth_service.dart';
                    ...
                    Consumer(
                      builder: (_, ref, __) {
                        if (ref.read(authProvider).currentUser != null) {
                          Admin admin =
                              ref.read(authProvider).currentUser as Admin;
